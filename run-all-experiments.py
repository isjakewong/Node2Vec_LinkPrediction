...
### ---------- Load in FB Graphs ---------- ###
FB_EGO_USERS = [00, 107, 1684, 1912, 3437, 348, 3980, 414, 686, 698]
...
with open(network_dir, 'rb') as f:
    adj, features = cPickle.load(f)
# pickle.dump(adj, features, open(network_dir, "wb"), protocol=2)
...
# pickle.dump(adj, features, open(combined_dir, "wb"), protocol=2)
with open(combined_dir, 'rb') as f:
    adj, features = cPickle.load(f)
fb_graphs['combined'] = f
